...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Override
    public Boolean updatePassword(Long loginUserId, String originalPassword, String newPassword, String token) {
        ...
        if (adminUser != null) {
            ...
            if (originalPassword.equals(adminUser.getLoginPassword())) {
                ...
                if (adminUserMapper.updateByPrimaryKeySelective(adminUser) > 0 && redisTemplate.delete(token)) {
